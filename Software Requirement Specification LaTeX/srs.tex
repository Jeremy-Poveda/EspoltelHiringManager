...
\textbf{Dependencies} & None \\ \hline
\textbf{Version} & V1.0 \\ \hline
\textbf{Description} & As an aspirant, I should be able to upload my personal documents (such as CV, document ID, certificates, etc.) and pertinent information to complete the application requirements.\\ \hline
\textbf{Reverse Card} & 
\begin{itemize}
     ...
     \item To receive the information in plain text, applicants will have to fill out a form made by Human Resources.
\end{itemize} \\ \hline
\end{tabularx} }
...
\textbf{Dependencies} & None \\ \hline
\textbf{Version} & V1.0 \\ \hline
\textbf{Description} & As a project manager, I want to be able to create a project by defining its name, description, start date, end date, and project type, so that the project’s objectives and timeline are clearly established. \\ \hline
\textbf{Reverse Card} & 
\begin{itemize}
...
\textbf{Reverse Card} & 
\begin{itemize}
    \item Human resources members should be able to access a checklist or list of requirements that can be cross-referenced with the applicant's provided details.
\end{itemize} \\ \hline
\end{tabularx} }
...
\textbf{Dependencies} & None \\ \hline
\textbf{Version} & V1.0 \\ \hline
\textbf{Description} & As a member of Human Resources, I should be able to upload contract and agreement templates for specific roles and hiring profiles, so that the appropriate templates are available for generating customized documents for applicants. \\ \hline
\textbf{Reverse Card} & 
\begin{itemize}
...
% User story - Schedule Interviews (Web application)
\begin{table}[H]
	\centering
	\small
	\resizebox{\textwidth}{!}{ \begin{tabularx}{\textwidth}{|l|X|}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{ \begin{tabularx}{\textwidth}{|l|X|}
			...
			\textbf{Version} & V1.0 \\ \hline
			\textbf{Description} & As an interviewer, I should be able to record the results and observations of the interviews conducted, including scores and comments, so that there is a formal record of the evaluation of each applicant. \\ \hline
			\textbf{Reverse Card} &
			\begin{itemize}
